...
def transfer_timit_taslp(timit_dir,data_cache,test_speakers,train_duration_max,test_duration_max,noise_type,noise_db):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--transfer_mode', dest='transfer_mode', type=str, choices=['rats','spectrogram','npy','codec','additive_noise','timit', 'timit_parallel', 'timit_taslp'], default=defaults["transfer_mode"], help='Transfer files as raw audio ,converted spectrogram, from npy files, using codecor adding noise.')
    ...
    elif args.transfer_mode == 'timit_taslp':
        transfer_timit_taslp("/content/drive/MyDrive/TIMIT_DATA",args.data_cache, ["MWBT0","FDHC0","MWEW0","FELC0"], 300, 300, "helicopter",args.noise_dB)
